...
class ModelConfig:
    def __init__(self, hyperparams):
        ...
        self.hidden_dropout_prob = float(hyperparams.get('dropout', 0.3))
        ...
        self.gradient_accumulations={'sentiment' : 1, 'sar': 1, 'neg': 1}
        self.max_batch_size = {'sentiment' : self.max_batch_size_sentiment, 'sar': self.max_batch_size_sarcasm, 'neg': self.max_batch_size_negation}
